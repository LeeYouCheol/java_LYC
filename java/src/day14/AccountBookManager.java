...
public class AccountBookManager implements ConsoleProgram{
	...
	public void excute(int menu) {
		switch(menu) {
		case 1:
			//readAccountBook();  이건 전체를 확인함.
			System.out.println("========================");
			System.out.println("항목을 선택하세요(1.전체확인 / 2. 날짜확인) : ");
		...
		case 2:
			if(insertAccountBook()) {
				System.out.println("내역을 저장했습니다.");
				System.out.println("========================");
			}else {
				System.out.println("내역 저장에 실패했습니다.");
				System.out.println("========================");
			}
			break;
		case 3:
	...
	public boolean modifyAccountBook() {
		...
		System.out.println("선택한 항목은 위 내용입니다. 수정하시겠습까?[예:true/아니오:false]");
		...
		System.out.println("결재방식을 수정하겠습니까?(true/false : )");
		ok = scan.nextBoolean();
		...
		System.out.println("항목방식을 수정하겠습니까?(true/false : )");
		ok = scan.nextBoolean();
