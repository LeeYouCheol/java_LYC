...
public class Ex4_casting {
	...
	public static void main(String[] args) {
		...
		//num4_1과 더하는 값이 정수이기 때문에 정수+정수를 한후 더한 값을 실수로 자동 타입변환을 하여 num4_4에 저장
		//더한후에 저장하기 전에 타입변환을 함
		double num4_4 = num4_1 + 5;
		System.out.println(num4_3);
		System.out.println(num4_4);
		
		//p.55~56 정수를 실수로 자동형변환할 때 정밀도가 떨어질 수 있다. int > float
		//int > float 으로 타입변환 하기보단 double로 타입변환하여 활용한다.
