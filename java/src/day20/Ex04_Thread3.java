...
public class Ex04_Thread3 {
	...
	public static void main(String[] args) {
		/* - 한 계좌에 동시에 2명이 접근해서 천원을 빼갈때 생길수 있는 문제점
		 * - 두개 이상의 스레드가 하나의 자원을 같이 이용하는 경우 생길수 있는 문제점*/
...
class BankBook{
	...
	//출금
	// synchronized : 동기화
	//메소드를 동기화 하면 어떤 어떤 스레드가 동기화 메소드를 실행하고 있으면
	// 다른 쓰레드에서 해당 메소드를 접근할 떼, 실행이 다 끝날때까지 일시정지 했다가(Blocked)
	//다 끝나면 그때 사용을 할 수 있다.
