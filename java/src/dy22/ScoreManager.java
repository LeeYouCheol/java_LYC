...
public class ScoreManager implements ConsoleProgram{
	...
	public ScoreManager(Scanner scan) {//스캐너를 이용하기 위한 생성자
		if(scan == null) {
	...
	public void run() {
		...
		list.add(new Score(2, 1, "영어", 100, 70, 90));
		list.add(new Score(2, 2, "수학", 80, 100, 70));
		int menu = -1;
		do {
			try {
