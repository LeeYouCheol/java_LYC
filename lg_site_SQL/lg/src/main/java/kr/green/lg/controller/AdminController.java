...
public class AdminController {
	...
	public ModelAndView productUpdateGet(ModelAndView mv, String pr_code) {
		...
		mv.setViewName("redirect:/admin/productUpdate");
		return mv;
	}
	@RequestMapping(value = "/admin/product/update", method = RequestMethod.POST)
	public ModelAndView productUpdatePost(ModelAndView mv, ProductVO product,
	...
	public ModelAndView noticeUpdatePost(ModelAndView mv, BoardVO board, HttpSession session
		,HttpServletResponse response) {
		MemberVO user = (MemberVO)session.getAttribute("user");
