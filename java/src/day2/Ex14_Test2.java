...
public class Ex14_Test2 {
	...
	public static void main(String[] args) {
		...
		if(score1 < 0 || score1 >100) {
			System.out.println(score1 + "점은 잘못된 성적 입니다.");
		}
		else if(score >= 90) {
			System.out.println(score1 + "점은 A학점");
		}
		else if(score >= 80) {
			System.out.println(score1 + "점은 B학점");
		}
		else if(score >= 70) {
			System.out.println(score1 + "점은 C학점");
		}
		else if(score >= 60) {
			System.out.println(score1 + "점은 D학점");
		}
		else {
			System.out.println(score1 + "점은 F학점");
		}
