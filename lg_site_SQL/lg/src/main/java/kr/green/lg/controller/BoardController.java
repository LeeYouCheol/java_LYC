...
public class BoardController {
	...
	public ModelAndView boardDeletePost(ModelAndView mv, Integer bd_num,
			HttpSession session, HttpServletResponse response, String bd_type) {
	...
	public ModelAndView boardUpdateGet(ModelAndView mv, Integer bd_num,
	...
	public ModelAndView boardUpdatePost(ModelAndView mv, BoardVO board, HttpSession session,
		...
		if(res)
			messageService.message(response, "게시글을 수정했습니다.", "/lg/product/select?pr_code="+board.getBd_pr_code());
		else
	...
	//ajax
		...
		@ResponseBody
		public Map<Object,Object> categoryList(@RequestBody Criteria cri) {
