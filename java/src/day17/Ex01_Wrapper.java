...
public class Ex01_Wrapper {
	...
	public static void main(String[] args) {
		/* - 클래스는 제네릭 클래스에서 기본 타입으로 된 제네릭을 만들고 싶지만
		 *   제네릭은 기본타입이 올수 없고, 클래스가 필요하다.
		 *   그래서 기본 타입으로 만든 Wrapper 클래스를 이용해여 한다.
		 * - Wrapper 클래스와 기본 타입의 차이
		 * 	 - Wrapper 클래스의 객체는 기본타입값과 null을 가짐
		 *     => 언박싱할 때 조심해야 함. null일수도 있기 때문
		...
		Integer num3 = null;
		//int num4 = num3; 예외발생. null을 기본타입으로 바꿀수 없음
		int num5 = 1, num6 = 1;
		System.out.print("두 기본타입 변수 ==로 비교 : ");
		if(num5 == num6) {
