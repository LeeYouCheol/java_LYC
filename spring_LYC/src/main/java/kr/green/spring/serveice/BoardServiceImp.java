...
public class BoardServiceImp implements BoardService{
	...
	public void deleteBoard(Integer bd_num, MemberVO user) {
		...
		if(fileList == null || fileList.size() == 0)
			return;
		//가져온 첨부파일들을 반복문을 이용하여 서버에서 삭제 후, DB에서 삭제
	...
	public Object updateLikes(LikesVO likes) {
		...
		//해당 게시물에 추천/비추천이 처음이면 insert
			if(dbLikes == null) {
				...
				//이전 추천/비추천 상태와 현재 추천/비추천 상태가 다른경우
	...
	@Override
	public String inserComment(CommentVO comment, MemberVO user) {
